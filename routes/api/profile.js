...
router.get('/all', (req, res) => {
  ...
  .then(profiles => {
    if (!profiles) {
      errors.noprofile = 'This is no profiles'
      return res.status(404).json(errors)
    }
    res.json(profiles)
  })
...
router.get('/user/:user_id', (req, res) => {
  ...
  .catch(err =>
    res.status(404).json({profile: 'There is no profile for this user'}, err))
})

// @route POST api/profile
// @tests Create or Edit user profile
// @accesse private
router.post(
  '/',
  ...
  (req, res) => {
    ...
    // Skills - we need to split into an array
...
// @routepost api/profile/experience
